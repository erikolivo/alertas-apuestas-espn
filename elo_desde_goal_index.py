...
------------------------
SIN CAMBIOS por la migracion a ESPN. Cuando un equipo no tiene Elo en
ClubElo pero SI tiene Goal Index, se estima un Elo base calibrando la
relacion Goal_Index -> Elo con los equipos que SI tienen ambos datos.
"""
